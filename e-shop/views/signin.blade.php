            ...
            <div class="col-md-12 col-lg-10">
                <div class="wrap d-md-flex my-5">
                    ...
                    <div class="col-lg-6 pl-md-5 ftco-animate">                
                        <h2 class="display-5 form-center my-5">ایجاد حساب کاربری</h2>
                        <form action="/sign-in" method="POST" style="text-align:right ;">
                            @csrf
                            ...
                            <div class="form-center">
                                    <button type="submit" class="btn shop-btn login-btn">ایجاد حساب</button>
                            </div>
                        </form>
                        <p class="form-txt my-5">قبلا ثبت نام کرده اید؟<a href="/login"><b>ورود به حساب</b></a></p>                
                    </div>		
                </div>
            </div>
        </div>
